            ...
            <div className=" bg-[#EDF3F8] py-28 rounded-md mt-10">
                <div className=" flex items-center justify-center max-w-[1380] gap-7 lg:flex-row-reverse pr-96">
                    <div className="max-w-xs rounded-lg shadow-2xl flex gap-5"  >
                        <img className="w-64 object-cover rounded-lg" src="https://i.ibb.co/3h2y78S/pexels-photography-maghradze-ph-10401187.jpg" alt="" />
                        <img className="w-64 object-cover rounded-lg" src="https://i.ibb.co/7KQfTLg/pexels-polina-tankilevitch-4110012.jpg" alt="" />
                        <img className="w-64 object-cover rounded-lg" src="https://i.ibb.co/TYMtKwV/pexels-fatih-do-rul-13659743.jpg" alt="" />
                    </div>
